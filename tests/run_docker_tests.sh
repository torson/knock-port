...
if [[ "${RUN_TESTS_ROUTING_TYPE_IPTABLES}"  = "true" ]]; then
    ...
    # curl -m 1 -d 'app=test_service_local&access_secret=test_secret_http' http://localhost:8080/12345
    # # with 2FA token
    # curl -m 1 -d 'app=test_service_local&access_secret=test_secret_http&token=' http://localhost:8080/12345
    # curl -m 1 -d 'app=test_service_local&access_secret=test_secret_https' https://localhost:8443/67890 -k
    # curl -m 1 http://localhost:1194/

    # curl -m 1 -d 'app=test_service_nonlocal&access_secret=test_secret_http' http://localhost:8080/12345
    # curl -m 1 -d 'app=test_service_nonlocal&access_secret=test_secret_https' https://localhost:8443/67890 -k
