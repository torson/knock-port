...
def parse_args():
    ...
    parser.add_argument('--run-with-sudo', action='store_true', default=False, help='Prefix all firewall commands with sudo (add something like "knockport ALL=NOPASSWD: /usr/sbin/nft *" in /etc/sudoers.d/knockport)')
